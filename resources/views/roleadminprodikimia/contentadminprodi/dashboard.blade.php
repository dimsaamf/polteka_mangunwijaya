@extends('roleadminprodikimia.layoutadminprodi.dashboard')
@section('content')
            ...
            <div class=" bg-white mt-6 shadow-[rgba(0,0,15,0.5)_2px_2px_2px_0px] shadow-slate-300 rounded-lg">
                <div class=" gap-6 mt-3">
                        <div class=" p-6">
                            ...
                            <div class="text-md text-slate-500 mt-1 font-normal text-justify">Anda Login sebagai Admin Program Studi Teknik Kimia Polteka Mangunwijaya</div>
                        </div>
                </div>
            </div>
            <div class="flex">
                            ...
                            <div class="px-6 py-2 mt-4">
                                <div class="flex w-full">
                                    ...
                                    <div class="flex w-1/2 justify-end text-xl font-medium mb-1">
                                        <a href="{{ route('riwayat.adminprodikimia') }}" >
                                ...
                                <form action="{{ route('reminder.update.adminprodikimia') }}" method="post" id="reminderForm">
                                    @csrf
