    ...
    <div class="fixed bg-putih-polteka w-full max-h-screen font-polteka">
      <div class="w-full h-screen flex flex-col items-center justify-center">
        <div class="w-1/2 md:1/3 lg:w-96 text-merah200-polteka">
          <img alt="Not Found"  src="{{ asset('unauthorized.svg') }}">
        </div>
        <div class="flex flex-col items-center justify-center font-polteka">
            <p class="text-3xl md:text-4xl lg:text-5xl text-gray-800 mt-3 font-semibold">Unauthorized</p>
            <p class="mx-5 text-center text-md md:text-lg lg:text-xl text-gray-600 mt-8">You are not authorized to access this page.</p>
