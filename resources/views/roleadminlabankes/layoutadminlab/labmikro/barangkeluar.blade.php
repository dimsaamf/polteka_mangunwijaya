...
<html>
    ...
    <head>
        ...
        <title>Barang Keluar Admin Laboratorium mikro</title>
    </head>
    <!-- END: Head -->
                ...
                <ul>
                    ...
                    <li class="hidden xl:block">
                        ...
                        <ul class=" xl:ml-[43px] mt-3 md:absolute xl:static left-5 xl:border-none xl:bg-none xl:text-start md:border md:w-40 md:bg-merah200-polteka md:rounded md:text-center">
                            ...
                            <li class="py-2 xl:py-0">
                                <a href="{{ route('barangkeluaradminlabmikro') }}" class="xl:text-hitam-polteka xl:bg-abu-polteka xl:rounded-full w-[500px] xl:ml-4 xl:py-2 xl:pl-5 xl:block mb-0 mt-0 xl:mb-1 xl:mt-1 md:font-bold xl:font-normal">
                                    Barang Keluar
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="block xl:hidden opcion-con-desplegable ">
                        ...
                        <ul class="hidden desplegable mt-3 absolute left-5 border w-40 bg-merah200-polteka rounded text-center">
                            ...
                            <li class="py-2 xl:py-0">
                                <a href="{{ route('databarangadminlabmikro') }}" class="w-[500px]">
                                    Data Barang
                                </a>
                            </li>
                            <li class="py-2 xl:py-0">
                                <a href="{{ route('barangmasukadminlabmikro') }}" class="w-[500px]">
                                    Barang Masuk
                                </a>
                            </li>
                            <li class="py-2 xl:py-0">
                                <a href="{{ route('barangkeluaradminlabmikro') }}" class=" w-[500px] mb-0 mt-0 font-bold">
                                    Barang Keluar
                                </a>
                            </li>
                        </ul>
