@extends('roleadminlabankes.layoutadminlab.labmikro.barangmasuk')
@section('content')
            ...
            <div class="-m-1.5 overflow-x-auto">
                ...
                <div class="flex">
                    <div class="flex w-1/2 justify-start mb-3">
                        <a href="{{ route('riwayatbarangmasukadminlabmikro') }}" type="button" class="w-[130px] mb-3 rounded-md px-3 py-2 text-sm bg-merah200-polteka text-putih-polteka shadow-sm">
                            Riwayat Barang
                        </a>
                    </div>
                    ...
                    <div class ="bg-merah180-polteka w-2/3 h-10 flex items-center rounded-l-full rounded-r-full">
                                <form action="{{ route('barangmasukadminlabmikro') }}" method="GET" class="relative flex w-full">
        ...
        <div id="default-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-auto fixed inset-0">
            ...
            <div class="fixed inset-0 overflow-y-auto flex items-center justify-center z-50">
                ...
                <div class="relative bg-white rounded-lg shadow w-[300px] sm:w-[450px] md:w-[500px]">
                    ...
                    <!-- Modal body -->
                    <div class="px-8">
                    <form action="{{ route('barangmasukadminlabmikro.store') }}" method="POST" enctype="multipart/form-data">  
                    @csrf
