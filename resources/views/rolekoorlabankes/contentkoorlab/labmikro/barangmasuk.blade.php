            ...
            <div class="-m-1.5 overflow-x-auto">
                ...
                <div class="flex">
                    <div class="flex w-1/2 justify-start mb-3">
                        <a href="{{ route('riwayatbarangmasukkoorlabmikro') }}" type="button" class="w-[130px] mb-3 rounded-md px-3 py-2 text-sm bg-merah200-polteka text-putih-polteka shadow-sm">
                            Riwayat Barang
                        </a>
                    </div>
                    ...
                    <div class ="bg-merah180-polteka w-2/3 h-10 flex items-center rounded-l-full rounded-r-full">
                                <form action="{{ route('barangmasukkoorlabmikro') }}" method="GET" class="relative flex w-full">
