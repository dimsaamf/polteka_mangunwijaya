    ...
    <section class="text-hitam-polteka">
        ...
        <div class="flex flex-col my-12 py-4 items-center space-y-5 overflow-x-auto">
            <ul class="inline-flex mx-autospace-x-2">
                @if ($BarangMasukSitohisto->onFirstPage())
                    <li>
                        <span class="px-4 py-2 text-gray-400 text-sm">Sebelumnya</span>
                    </li>
                @else
                    <li>
                        <a href="{{ $BarangMasukSitohisto->previousPageUrl() }}" class="px-4 py-2 text-hitam-polteka hover:font-bold text-sm">Sebelumnya</a>
                    </li>
                @endif
        
                @foreach ($BarangMasukSitohisto->getUrlRange($BarangMasukSitohisto->currentPage() - 2, $BarangMasukSitohisto->currentPage() + 2) as $page => $url)
                    @if ($page == $BarangMasukSitohisto->currentPage())
                        <li>
                ...
                @if ($BarangMasukSitohisto->hasMorePages())
                    <li>
                        <a href="{{ $BarangMasukSitohisto->nextPageUrl() }}" class="px-4 py-2 text-hitam-polteka hover:font-bold hover:text-hitam-polteka text-sm">Selanjutnya</a>
                    </li>
                @else
                    <li>
