        ...
        <div class=" bg-white mt-6 shadow-[rgba(0,0,15,0.5)_2px_2px_2px_0px] shadow-slate-300 rounded-lg">
            <div class=" gap-6 mt-3">
                    <div class=" p-6">
                        ...
                        <div class="text-md text-slate-500 mt-1 font-normal text-justify">Anda Login sebagai koor koor Laboratorium Prodi Analisis Kesehatan Polteka Mangunwijaya</div>
                    </div>
            </div>
        </div>
        <div class="flex">
