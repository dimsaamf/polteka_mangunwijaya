    ...
    <body class="py-5 bg-merah200-polteka text-putih-polteka font-polteka">
        ...
        <div class="block md:hidden bg-merah200-polteka text-putih-polteka">
            ...
            <ul class="py-5 mx-8 mobileMenu hidden">
                ...
                <li>
                    <a href="{{ route('pengajuanbarangkoorlabankes') }}" class="flex font-semibold">
                        <div>
            ...
            <nav class="hidden md:block xl:w-[20%] lg:w-[12%] md:w-[12%]">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a href="{{ route('pengajuanbarangkoorlabankes') }}" class="xl:hidden justify-start mb-2 flex pt-2 md:px-5 lg:px-7 text-hitam-polteka bg-abu-polteka rounded-full md:ml-6 lg:ml-10 w-full">
                            <div class="xl:ml-8 mb-3">
                    ...
                    <li class="opcion-con-desplegable">
                        ...
                        <ul class="desplegable xl:ml-[43px] mt-3 hidden md:absolute xl:static left-5 xl:border-none xl:bg-none xl:text-start md:border md:w-40 md:bg-merah200-polteka md:rounded md:text-center">
                            ...
                            <li class="py-2 xl:py-0">
                                <a href="{{ route('databarangkoorlabsitohisto') }}" class="xl:hover:text-hitam-polteka xl:hover:bg-abu-polteka xl:hover:rounded-full xl:hover:w-52 xl:hover:ml-4 xl:py-2 xl:pl-5 xl:block">
                                    Data Barang
                                </a>
                            </li>
                            <li class="py-2 xl:py-0">
                                <a href="{{ route('barangmasukkoorlabsitohisto') }}" class="xl:hover:text-hitam-polteka xl:hover:bg-abu-polteka xl:hover:rounded-full xl:hover:w-52 xl:hover:ml-4 xl:py-2 xl:pl-5 xl:block">
                                    Barang Masuk
                                </a>
                            </li>
                            <li class="py-2 xl:py-0">
                                <a href="{{ route('barangkeluarkoorlabsitohisto') }}" class="xl:hover:text-hitam-polteka xl:hover:bg-abu-polteka xl:hover:rounded-full xl:hover:w-52 xl:hover:ml-4 xl:py-2 xl:pl-5 xl:block">
                                    Barang Keluar
                                </a>
                            </li>
                        </ul>
