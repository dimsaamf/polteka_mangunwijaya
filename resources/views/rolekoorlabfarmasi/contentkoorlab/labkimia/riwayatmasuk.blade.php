            ...
            <div class="-m-1.5 overflow-x-auto">
                ...
                <div class="flex">
                    ...
                    <div class="flex w-1/2 justify-start mb-3 items-center">
                        <form action="{{ route('riwayatbarangmasukkoorlabfarmasikimia') }}" method="GET" class="flex gap-3 my-auto items-center">
                        ...
                        <form action="{{ route('riwayatbarangmasukkoorlabfarmasikimia') }}" method="GET">
