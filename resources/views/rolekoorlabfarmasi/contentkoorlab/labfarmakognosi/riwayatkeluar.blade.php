            ...
            <div class="-m-1.5 overflow-x-auto">
                ...
                <div class="flex">
                    ...
                    <div class="flex w-1/2 justify-start mb-3 items-center">
                        <form action="{{ route('riwayatbarangkeluarkoorlabfarmakognosi') }}" method="GET" class="items-center flex gap-3 my-auto items-center">
                        ...
                        <form action="{{ route('riwayatbarangkeluarkoorlabfarmakognosi') }}" method="GET">
                            <button type="submit" class="btn btn-secondary ml-1 mt-7 w-[25px] h-[24px]  rounded-md px-1 bg-merah200-polteka text-putih-polteka shadow-sm">
                    ...
                    <div class="flex w-1/2 justify-end mt-5 mb-3">
                                    ...
                                    <form action="{{ route('riwayatbarangkeluarkoorlabfarmakognosi') }}" method="GET" class="relative flex w-full">
