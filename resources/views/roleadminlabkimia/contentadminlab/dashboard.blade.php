@extends('roleadminlabkimia.layoutadminlab.dashboard')
@section('content')
...
<div class="bg-abu-polteka w-full min-h-[500px] px-9 md:rounded-xl rounded-[30px] md:mt-0 md:ml-0 md:mr-0 mt-6 ml-8 mr-8">
    ...
    <section class="w-full mt-2  mb-5 h-14 border-b border-slate-300">
        ...
        <div class="hidden md:flex my-4 w-1/2 justify-start text-xs sm:text-md md:text-[13px] lg:text-lg">
            <div class="mr-2 text-merah180-polteka">Hai, Admin Lab Prodi Analisis Kesehatan</div>
        ...
        <div class=" bg-white mt-6 shadow-[rgba(0,0,15,0.5)_2px_2px_2px_0px] shadow-slate-300 rounded-lg">
            <div class=" gap-6 mt-3">
                    <div class=" p-6">
                        ...
                        <div class="text-md text-slate-500 mt-1 font-normal text-justify">Anda Login sebagai Admin Laboratorium Prodi Analisis Kesehatan Polteka Mangunwijaya</div>
                    </div>
            </div>
        </div>
        <div class="flex">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-10 w-full">
                                <div class="bg-abu-polteka shadow-[rgba(0,0,15,0.5)_2px_2px_2px_0px] shadow-slate-300 rounded-lg w-full">
                                    <div class="p-6">
                                        ...
                                        <form action="{{ route('reminder.updatekimiaanalisa') }}" method="post" id="reminderForm">
                                            ...
                                            @if ($kimiaanalisareminders->isEmpty())
                                        ...
                                        <div class="flex flex-col my-2 py-3 items-center space-y-5 overflow-x-auto mb-4">
                                            <ul class="inline-flex mx-autospace-x-2">
                                                @if ($kimiaanalisareminders->onFirstPage())
                                                    <li>
                                                        <span class="px-4 py-2 text-gray-400 text-sm">Sebelumnya</span>
                                                    </li>
                                                @else
                                                    <li>
                                                        <a href="{{ $kimiaanalisareminders->previousPageUrl() }}" class="px-4 py-2 text-hitam-polteka hover:font-bold text-sm">Sebelumnya</a>
                                                    </li>
                                                @endif
                                        
                                                @foreach ($kimiaanalisareminders->getUrlRange($kimiaanalisareminders->currentPage() - 2, $kimiaanalisareminders->currentPage() + 2) as $page => $url)
                                                    @if ($page == $kimiaanalisareminders->currentPage())
                                                        <li>
                                                            <a href="{{ $url }}" class="px-4 py-2 text-putih-polteka bg-biru160-polteka hover:bg-biru100-polteka rounded-full text-sm">{{ $page }}</a>
                                                        </li>
                                                    @endif
                                                ...
                                                @if ($kimiaanalisareminders->hasMorePages())
                                                    <li>
                                                        <a href="{{ $kimiaanalisareminders->nextPageUrl() }}" class="px-4 py-2 text-hitam-polteka hover:font-bold hover:text-hitam-polteka text-sm">Selanjutnya</a>
                                                    </li>
                                                @else
                                                    <li>
                                                        <span class="px-4 py-2 text-gray-400 text-sm">Selanjutnya</span>
                                ...
                                <div class="bg-abu-polteka shadow-[rgba(0,0,15,0.5)_2px_2px_2px_0px] shadow-slate-300 rounded-lg w-full">
                                    <div class="p-6">
                                        ...
                                        <form action="{{ route('reminder.updatekimiafisika') }}" method="post" id="reminderForm">
                                            ...
                                            @if ($kimiafisikareminders->isEmpty())
                                                <div class="text-sm text-gray-500 mt-4">Tidak ada barang yang perlu diservice saat ini.</div>
                                            @endif
                                        ...
                                        <div class="flex flex-col my-2 py-3 items-center space-y-5 overflow-x-auto mb-4">
                                            <ul class="inline-flex mx-autospace-x-2">
                                                @if ($kimiafisikareminders->onFirstPage())
                                                    <li>
                                                        <span class="px-4 py-2 text-gray-400 text-sm">Sebelumnya</span>
                                                    </li>
                                                @else
                                                    <li>
                                                        <a href="{{ $kimiafisikareminders->previousPageUrl() }}" class="px-4 py-2 text-hitam-polteka hover:font-bold text-sm">Sebelumnya</a>
                                                    </li>
                                                @endif
                                        
                                                @foreach ($kimiafisikareminders->getUrlRange($kimiafisikareminders->currentPage() - 2, $kimiafisikareminders->currentPage() + 2) as $page => $url)
                                                    @if ($page == $kimiafisikareminders->currentPage())
                                                        <li>
                                                            <a href="{{ $url }}" class="px-4 py-2 text-putih-polteka bg-biru160-polteka hover:bg-biru100-polteka rounded-full text-sm">{{ $page }}</a>
                                                        </li>
                                                    @endif
                                                ...
                                                @if ($kimiafisikareminders->hasMorePages())
                                                    <li>
                                                        <a href="{{ $kimiafisikareminders->nextPageUrl() }}" class="px-4 py-2 text-hitam-polteka hover:font-bold hover:text-hitam-polteka text-sm">Selanjutnya</a>
                                                    </li>
                                                @else
                                                    <li>
                                                        <span class="px-4 py-2 text-gray-400 text-sm">Selanjutnya</span>
                                ...
                                <div class="bg-abu-polteka shadow-[rgba(0,0,15,0.5)_2px_2px_2px_0px] shadow-slate-300 rounded-lg w-full">
                                    <div class="p-6">
                                        ...
                                        <form action="{{ route('reminder.updatekimiaorganik') }}" method="post" id="reminderForm">
                                            ...
                                            @if ($kimiaorganikreminders->isEmpty())
                                                <div class="text-sm text-gray-500 mt-4">Tidak ada barang yang perlu diservice saat ini.</div>
                                            @endif
                                        ...
                                        <div class="flex flex-col my-2 py-3 items-center space-y-5 overflow-x-auto mb-4">
                                            <ul class="inline-flex mx-autospace-x-2">
                                                @if ($kimiaorganikreminders->onFirstPage())
                                                    <li>
                                                        <span class="px-4 py-2 text-gray-400 text-sm">Sebelumnya</span>
                                                    </li>
                                                @else
                                                    <li>
                                                        <a href="{{ $kimiaorganikreminders->previousPageUrl() }}" class="px-4 py-2 text-hitam-polteka hover:font-bold text-sm">Sebelumnya</a>
                                                    </li>
                                                @endif
                                        
                                                @foreach ($kimiaorganikreminders->getUrlRange($kimiaorganikreminders->currentPage() - 2, $kimiaorganikreminders->currentPage() + 2) as $page => $url)
                                                    @if ($page == $kimiaorganikreminders->currentPage())
                                                        <li>
                                                            <a href="{{ $url }}" class="px-4 py-2 text-putih-polteka bg-biru160-polteka hover:bg-biru100-polteka rounded-full text-sm">{{ $page }}</a>
                                                        </li>
                                                    @endif
                                                ...
                                                @if ($kimiaorganikreminders->hasMorePages())
                                                    <li>
                                                        <a href="{{ $kimiaorganikreminders->nextPageUrl() }}" class="px-4 py-2 text-hitam-polteka hover:font-bold hover:text-hitam-polteka text-sm">Selanjutnya</a>
                                                    </li>
                                                @else
                                                    <li>
                                                        <span class="px-4 py-2 text-gray-400 text-sm">Selanjutnya</span>
                                ...
                                <div class="bg-abu-polteka shadow-[rgba(0,0,15,0.5)_2px_2px_2px_0px] shadow-slate-300 rounded-lg w-full">
                                    <div class="p-6">
                                        ...
                                        <form action="{{ route('reminder.updatekimiaterapan') }}" method="post" id="reminderForm">
                                            ...
                                            @if ($kimiaterapanreminders->isEmpty())
                                                <div class="text-sm text-gray-500 mt-4">Tidak ada barang yang perlu diservice saat ini.</div>
                                            @endif
                                        ...
                                        <div class="flex flex-col my-2 py-3 items-center space-y-5 overflow-x-auto mb-4">
                                            <ul class="inline-flex mx-autospace-x-2">
                                                @if ($kimiaterapanreminders->onFirstPage())
                                                    <li>
                                                        <span class="px-4 py-2 text-gray-400 text-sm">Sebelumnya</span>
                                                    </li>
                                                @else
                                                    <li>
                                                        <a href="{{ $kimiaterapanreminders->previousPageUrl() }}" class="px-4 py-2 text-hitam-polteka hover:font-bold text-sm">Sebelumnya</a>
                                                    </li>
                                                @endif
                                        
                                                @foreach ($kimiaterapanreminders->getUrlRange($kimiaterapanreminders->currentPage() - 2, $kimiaterapanreminders->currentPage() + 2) as $page => $url)
                                                    @if ($page == $kimiaterapanreminders->currentPage())
                                                        <li>
                                                            <a href="{{ $url }}" class="px-4 py-2 text-putih-polteka bg-biru160-polteka hover:bg-biru100-polteka rounded-full text-sm">{{ $page }}</a>
                                                        </li>
                                                    @endif
                                                ...
                                                @if ($kimiaterapanreminders->hasMorePages())
                                                    <li>
                                                        <a href="{{ $kimiaterapanreminders->nextPageUrl() }}" class="px-4 py-2 text-hitam-polteka hover:font-bold hover:text-hitam-polteka text-sm">Selanjutnya</a>
                                                    </li>
                                                @else
                                                    <li>
                                                        <span class="px-4 py-2 text-gray-400 text-sm">Selanjutnya</span>
                                ...
                                <div class="bg-abu-polteka shadow-[rgba(0,0,15,0.5)_2px_2px_2px_0px] shadow-slate-300 rounded-lg w-full">
                                    <div class="p-6">
                                        ...
                                        <form action="{{ route('reminder.updatemikrobiologi') }}" method="post" id="reminderForm">
                                            ...
                                            @if ($mikrobiologireminders->isEmpty())
                                                <div class="text-sm text-gray-500 mt-4">Tidak ada barang yang perlu diservice saat ini.</div>
                                            @endif
                                        ...
                                        <div class="flex flex-col my-2 py-3 items-center space-y-5 overflow-x-auto mb-4">
                                            <ul class="inline-flex mx-autospace-x-2">
                                                @if ($mikrobiologireminders->onFirstPage())
                                                    <li>
                                                        <span class="px-4 py-2 text-gray-400 text-sm">Sebelumnya</span>
                                                    </li>
                                                @else
                                                    <li>
                                                        <a href="{{ $mikrobiologireminders->previousPageUrl() }}" class="px-4 py-2 text-hitam-polteka hover:font-bold text-sm">Sebelumnya</a>
                                                    </li>
                                                @endif
                                        
                                                @foreach ($mikrobiologireminders->getUrlRange($mikrobiologireminders->currentPage() - 2, $mikrobiologireminders->currentPage() + 2) as $page => $url)
                                                    @if ($page == $mikrobiologireminders->currentPage())
                                                        <li>
                                                            <a href="{{ $url }}" class="px-4 py-2 text-putih-polteka bg-biru160-polteka hover:bg-biru100-polteka rounded-full text-sm">{{ $page }}</a>
                                                        </li>
                                                    @endif
                                                ...
                                                @if ($mikrobiologireminders->hasMorePages())
                                                    <li>
                                                        <a href="{{ $mikrobiologireminders->nextPageUrl() }}" class="px-4 py-2 text-hitam-polteka hover:font-bold hover:text-hitam-polteka text-sm">Selanjutnya</a>
                                                    </li>
                                                @else
                                                    <li>
                                                        <span class="px-4 py-2 text-gray-400 text-sm">Selanjutnya</span>
                                ...
                                <div class="bg-abu-polteka shadow-[rgba(0,0,15,0.5)_2px_2px_2px_0px] shadow-slate-300 rounded-lg w-full">
                                    <div class="p-6">
                                        ...
                                        <div class="flex flex-col my-2 py-3 items-center space-y-5 overflow-x-auto mb-4">
                                            <ul class="inline-flex mx-autospace-x-2">
                                                @if ($optekkimreminders->onFirstPage())
                                                    <li>
                                                        <span class="px-4 py-2 text-gray-400 text-sm">Sebelumnya</span>
                                                    </li>
                                                @else
                                                    <li>
                                                        <a href="{{ $optekkimreminders->previousPageUrl() }}" class="px-4 py-2 text-hitam-polteka hover:font-bold text-sm">Sebelumnya</a>
                                                    </li>
                                                @endif
                                        
                                                @foreach ($optekkimreminders->getUrlRange($optekkimreminders->currentPage() - 2, $optekkimreminders->currentPage() + 2) as $page => $url)
                                                    @if ($page == $optekkimreminders->currentPage())
                                                        <li>
                                                            <a href="{{ $url }}" class="px-4 py-2 text-putih-polteka bg-biru160-polteka hover:bg-biru100-polteka rounded-full text-sm">{{ $page }}</a>
                                                        </li>
                                                    @endif
                                                ...
                                                @if ($optekkimreminders->hasMorePages())
                                                    <li>
                                                        <a href="{{ $optekkimreminders->nextPageUrl() }}" class="px-4 py-2 text-hitam-polteka hover:font-bold hover:text-hitam-polteka text-sm">Selanjutnya</a>
                                                    </li>
                                                @else
                                                    <li>
                                                        <span class="px-4 py-2 text-gray-400 text-sm">Selanjutnya</span>
