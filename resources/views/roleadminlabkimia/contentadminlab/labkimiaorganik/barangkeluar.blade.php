                ...
                <div class="relative bg-white rounded-lg shadow w-[300px] sm:w-[450px] md:w-[500px]">
                    ...
                    @csrf
                        <label class="block mt-4">
                            ...
                            <input type="number" name="jumlah_keluar" class="mt-2 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="Jumlah Barang" />
                        </label>
                    </div>
                    <div class="px-8">
                        <label class="block mt-4">
