    ...
    <body class="py-5 bg-merah200-polteka text-putih-polteka font-polteka">
        ...
        <div class="block md:hidden bg-merah200-polteka text-putih-polteka">
            <div class="flex mr-auto">
                ...
                <a href="#" class="mr-8">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-10" viewBox="0 0 24 24"><path fill="currentColor" d="M4 18h16c.55 0 1-.45 1-1s-.45-1-1-1H4c-.55 0-1 .45-1 1s.45 1 1 1m0-5h16c.55 0 1-.45 1-1s-.45-1-1-1H4c-.55 0-1 .45-1 1s.45 1 1 1M3 7c0 .55.45 1 1 1h16c.55 0 1-.45 1-1s-.45-1-1-1H4c-.55 0-1 .45-1 1"/></svg>
                </a>
            </div>
            ...
            <ul class="py-5 mx-8">
                ...
                <li class="menu__devider my-6"></li>
                <li>
                    <a href="#" class="flex" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
        ...
        <div class="flex md:mr-8 bg-merah200-polteka text-putih-polteka">
            ...
            <nav class="hidden md:block xl:w-[20%] lg:w-[12%] md:w-[12%]">
                ...
                <ul>
                    <li>
                        <a class="md:justify-center lg:justify-center xl:justify-start flex pt-2 text-hitam-polteka bg-abu-polteka rounded-full xl:ml-8 lg:ml-10 md:ml-6 w-full">
