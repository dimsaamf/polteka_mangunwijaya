                        ...
                        @foreach($paginatedPengajuanBarangs as $pengajuanbarang)
                            <tr class="text-center bg-putih-polteka border-y-8 border-abu-polteka">
                                ...
                                <td class="px-6 py-2 whitespace-nowrap">
                                    <a href="{{ route('preview.suratwadir', ['id' => $pengajuanbarang->kode_pengajuan]) }}" target="_blank">
                                ...
                                <td class="px-3 py-2 whitespace-nowrap rounded-r-xl flex justify-center space-x-4">
                                    <a href="{{ route('detailpengajuanwadir', ['id' => $pengajuanbarang->kode_pengajuan]) }}" data-modal-target="default-modal" data-modal-toggle="default-modal" >
