@extends('rolekoorlabkimia.layoutkoorlab.pengajuan')
@section('content')
...
<div class="bg-abu-polteka font-polteka w-full min-h-[500px] px-8 md:rounded-xl rounded-[30px] md:mt-0 md:ml-0 md:mr-0 mt-6 ml-8 mr-8 mb-0 overflow-x-auto">
    ...
    <section class="text-hitam-polteka">
        ...
        <div class="justify-start mt-5">
            <a href="{{ route('tambahpengajuankoorlabkimia') }}" class="w-[170px] mb-3 rounded-md px-3 py-2 text-sm bg-merah200-polteka text-putih-polteka shadow-sm">
                Tambah Pengajuan
            </a>
        </div>
                    ...
                    <tbody>
                        ...
                        @foreach($pengajuanBarangs as $pengajuanbarang)
                            <tr class="text-center bg-putih-polteka border-y-8 border-abu-polteka">
                                <input type="hidden" class="delete_id" value="{{$pengajuanbarang->kode_pengajuan}}">
                                ...
                                <td class="px-6 py-2 whitespace-nowrap">
                                    <a href="{{ route('preview.surat.koorlabkimia', ['id' => $pengajuanbarang->kode_pengajuan]) }}" target="_blank">
                                ...
                                <td class="px-6 py-2 whitespace-nowrap rounded-r-xl flex justify-center space-x-4">
                                    <a href="{{ route('detailpengajuankoorlabkimia', ['id' => $pengajuanbarang->kode_pengajuan]) }}" data-modal-target="default-modal" data-modal-toggle="default-modal" >
                                    ...
                                    @else
                                        <a href="{{ route('editpengajuankoorlabkimia', ['id' => $pengajuanbarang->kode_pengajuan]) }}">
                                    ...
                                    @else
                                        <form action="{{ route('hapuspengajuankoorlabkimia', ['id' => $pengajuanbarang->kode_pengajuan]) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
        ...
        $('.btndelete').click(function (e){
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: '/koorlabkimia/hapuspengajuan/' + deleteid,
                        data: data,
