@extends('rolekoorlabkimia.layoutkoorlab.labkimiaanalisa.barangkeluar')
@section('content')
            ...
            <div class="-m-1.5 overflow-x-auto">
                ...
                <div class="flex">
                    <div class="flex w-1/2 justify-start mb-3">
                        <a href="{{ route('riwayatbarangkeluarkoorlabkimiaanalisa') }}" type="button" class="w-[130px] mb-3 rounded-md px-3 py-2 text-sm bg-merah200-polteka text-putih-polteka shadow-sm">
                            Riwayat Barang
                        </a>
                    </div>
                    <div class="flex w-1/2 justify-end mb-3">
                                    ...
                                    <form action="{{ route('barangkeluarkoorlabkimiaanalisa') }}" method="GET" class="relative flex w-full">
                        ...
                        <tr class="text-center bg-putih-polteka border-y-8 border-abu-polteka">
                            ...
                            <td class="px-6 py-2 whitespace-nowrap">
                                    <div class="flex justify-center">
                                        @if($item->gambar)
                                            <a href="{{ route('get.gambar.invlabkimiaanalisa.koor', ['id' => $item->id]) }}" target="_blank">
        ...
        <div id="default-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-auto fixed inset-0">
            ...
            <div class="fixed inset-0 overflow-y-auto flex items-center justify-center z-50">
                ...
                <div class="relative bg-white rounded-lg shadow w-[300px] sm:w-[450px] md:w-[500px]">
                    ...
                    <!-- Modal body -->
                    <div class="px-8">
                    <form action="{{ route('barangkeluarkoorlabkimiaanalisa.store') }}" method="POST" enctype="multipart/form-data">  
                    @csrf
