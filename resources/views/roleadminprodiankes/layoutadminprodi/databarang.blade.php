...
<html>
    ...
    <head>
        ...
        <title>Data Barang Admin Prodi Analisis Kesehatan</title>
    </head>
    <!-- END: Head -->
    <body class="py-5 bg-merah200-polteka text-putih-polteka font-polteka">
        ...
        <div class="block md:hidden bg-merah200-polteka text-putih-polteka">
            ...
            <ul class="py-5 mx-8 mobileMenu hidden">
                ...
                <li>
                    <a href="{{ route('databarangadminprodiankes') }}" class="flex font-semibold">
                        <div>
            ...
            <nav class="hidden md:block xl:w-[20%] lg:w-[12%] md:w-[12%]">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a href="{{ route('databarangadminprodiankes') }}" class="xl:hidden justify-start mb-2 flex pt-2 md:px-5 lg:px-7 text-hitam-polteka bg-abu-polteka rounded-full md:ml-6 lg:ml-10 w-full">
                            <div class="xl:ml-8 mb-3">
