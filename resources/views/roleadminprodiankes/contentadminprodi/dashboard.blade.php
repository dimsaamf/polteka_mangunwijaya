@extends('roleadminprodiankes.layoutadminprodi.dashboard')
@section('content')
            ...
            <div class=" bg-white mt-6 shadow-[rgba(0,0,15,0.5)_2px_2px_2px_0px] shadow-slate-300 rounded-lg">
                <div class=" gap-6 mt-3">
                        <div class=" p-6">
                            ...
                            <div class="text-md text-slate-500 mt-1 font-normal text-justify">Anda Login sebagai Admin Program Studi Analisis Kesehatan Polteka Mangunwijaya</div>
                        </div>
                </div>
            </div>
            <div class="flex">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-3 md:gap-8 w-full mb-5">
                    <div class="bg-white flex mt-6 shadow-[rgba(0,0,15,0.5)_2px_2px_2px_0px] shadow-slate-300 rounded-lg justify-center xl:justify-start items-center">
                        <div class="box py-6 px-3 ml-0 xl:ml-6">
                        ...
                        <div class="box p-6">
                            <div class="text-3xl font-medium">{{ $jumlah_barang }}</div>
                    ...
                    <div class="bg-white flex mt-6 shadow-[rgba(0,0,15,0.5)_2px_2px_2px_0px] shadow-slate-300 rounded-lg justify-center xl:justify-start items-center">
                        ...
                        <div class="box p-6">
                            <div class="text-3xl font-medium">{{ $jumlah_barang_masuk }}</div>
                    ...
                    <div class="bg-white flex mt-6 shadow-[rgba(0,0,15,0.5)_2px_2px_2px_0px] shadow-slate-300 rounded-lg justify-center xl:justify-start items-center">
                        ...
                        <div class="box p-6">
                            <div class="text-3xl font-medium">{{ $jumlah_barang_keluar }}</div>
                        ...
                        <div class="px-6 py-2 mt-4">
                            <div class="flex w-full">
                                ...
                                <div class="flex w-1/2 justify-end text-xl font-medium mb-1">
                                    <a href="{{ route('riwayat.adminprodiankes') }}" >
                            ...
                            <form action="{{ route('reminder.update.adminprodiankes') }}" method="post" id="reminderForm">
                                @csrf
