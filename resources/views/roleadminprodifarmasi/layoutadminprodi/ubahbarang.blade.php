...
<html>
    ...
    <head>
        ...
        <title>Ubah Barang Admin Prodi Farmasi</title>
    </head>
    <!-- END: Head -->
            ...
            <nav class="hidden md:block xl:w-[20%] lg:w-[12%] md:w-[12%]">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a href="#" class="xl:hidden mb-2 justify-start flex pt-2 md:px-5 lg:px-7 text-hitam-polteka bg-abu-polteka rounded-full md:ml-6 lg:ml-10 w-full">
                            <div class="xl:ml-8 mb-3">
