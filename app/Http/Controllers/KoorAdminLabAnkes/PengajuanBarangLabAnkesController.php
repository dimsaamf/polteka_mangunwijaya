...
class PengajuanBarangLabAnkesController extends Controller
{
    public function index()
    {
        $pengajuanBarangs = PengajuanBarangLabAnkes::paginate(10);
        return view('rolekoorlabankes.contentkoorlab.pengajuan', compact('pengajuanBarangs'));

    }

    public function show($kode_pengajuan)
    {
        $pengajuanBarang = PengajuanBarangLabAnkes::findOrFail($kode_pengajuan);
        return view('rolekoorlabankes.contentkoorlab.detailpengajuan', compact('pengajuanBarang'));
    }

    public function create()
    {
        return view('rolekoorlabankes.contentkoorlab.tambahpengajuan');
    }
    ...
    public function store(Request $request)
    {
        ...
        $kode_pengajuan = uniqid('ANKES') . '_' . time();
        ...
        $prodiDefault = 'Prodi Analisis Kesehatan';
        ...
        if (!empty($request->harga)) { // Periksa apakah $request->harga tidak kosong
            ...
            $pengajuan = PengajuanBarangLabAnkes::create([
    ...
    {
        $pengajuanBarang = PengajuanBarangLabAnkes::findOrFail($kode_pengajuan);
        return view('rolekoorlabankes.contentkoorlab.editpengajuan', compact('pengajuanBarang'));
    }
