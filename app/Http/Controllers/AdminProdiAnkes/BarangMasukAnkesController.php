...
class BarangMasukAnkesController extends Controller
{
    public function index(Request $request){
        ...
        $queryBuilder = BarangMasukAnkes::with('InventarisAnkes')
    ...
    public function tabel(Request $request) {
        ...
        return view('roleadminprodiankes.contentadminprodi.barangmasuk', compact('data'));
    }
    

    public function create(){
        return view('roleadminprodiankes.contentadminprodi.barangmasuk');
    }
    ...
    public function store(Request $request)
    {
        ...
        $barangmasukankes = new BarangMasukAnkes();
        $barangmasukankes->jumlah_masuk = $jumlah_masuk_baru;
        $barangmasukankes->tanggal_masuk = $request->tanggal_masuk;
        $barangmasukankes->keterangan_masuk = $request->keterangan_masuk;
        $barangmasukankes->id_barang = $id_barang;
        $barangmasukankes->save();

        alert()->success('Berhasil','Stok Barang Berhasil Ditambahkan.');
        return redirect()->route('barangmasukadminprodiankes');
